...
out=root/'submission'/'zhiwan-product-plan.pdf'
...
def frame(canvas,doc):
    ...
    canvas.setFillColor(ink);canvas.setFont('ZH-Bold',13);canvas.drawString(43,801,'知玩')
...
doc=SimpleDocTemplate(str(out),pagesize=A4,rightMargin=43,leftMargin=43,topMargin=81,bottomMargin=55,title='知玩 · 产品说明与计划书',author='知玩项目')
