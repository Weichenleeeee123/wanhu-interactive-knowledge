...
> = {
  "gradient-descent": LessonSchema.parse({
    ...
    prediction:
      "从 x = 8 出发，先用学习率 0.20。小球会靠近谷底、来回震荡，还是越走越远？先留下判断，再比较其他学习率。",
    observation:
      "先用 0.20 单步前进，再切换 0.50、1.00 和 1.20 的情景。留意小球的位置和损失值，也可以展开下方对照台，同步比较四种学习率。",
    explanation:
  ...
  "monty-hall": LessonSchema.parse({
    ...
    goal: "通过预测和对照实验，理解主持人的规则怎样影响换门决策。",
    prediction:
