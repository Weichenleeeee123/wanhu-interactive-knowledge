...
declare const chrome: {
  ...
  tabs:{get:(id:number)=>Promise<{id?:number;url?:string}>;sendMessage:(id:number,message:unknown)=>Promise<unknown>;create:(options:{url:string})=>Promise<unknown>};
...
declare const __MASCOT_ICON__:string;
