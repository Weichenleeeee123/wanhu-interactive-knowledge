      ...
      <section className="extension-hero">
        <div>
          ...
          <div className="extension-actions">
            <a className="button primary large" href="/downloads/wanhu-extension.zip?v=0.4.3" download>下载玩乎插件 ↓</a>
            <Link className="text-link" href="/create">先在网页工坊体验 →</Link>
          </div>
          <p className="extension-meta">支持 Chrome / Edge · 当前为开发者模式安装包 · 版本 0.4.3</p>
        </div>
