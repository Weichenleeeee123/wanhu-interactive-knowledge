...
- 本地 107 项单元测试、47 项网页测试、13 项插件测试通过，类型检查及生产构建通过；
...
本轮按知乎插件与网页、创作者与读者逐条检查，修复了 SVG 首帧播放崩溃、真实知乎链接导入、读者新建角色丢失、知乎包装外链自动识别、正文演示与侧栏列表接续和窄屏遮挡。已有插件需要更新至 0.4.2 并刷新知乎。详细流程、真实测试与能力边界见 [两端两用户验收记录](../docs/journey-audit-2026-09-14.md)。
